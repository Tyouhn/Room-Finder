...
<body class = "main">
    <div id = 'wrapperBody' class = "wrappers " align = "center">
        <h1 calss = "titleColor"> Room List</h1>
            ...
            <table>
                ...
                <tr>
                    <td>    
                        ...
                        <select id = "building" name = "buidling">
                            <option value = "bNull"> -------</option>
                            <option value = "west16"> 16 West</option>
                            <option value = "west26"> 26 West</option>
                            <option value = "main"> Global Center</option>
                        </select>
                    </td>
                </tr>
